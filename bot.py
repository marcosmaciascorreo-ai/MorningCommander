...
AYUDA_TEXTO = (
    "MORNING COMMANDER — Comandos disponibles\n"
    "Escribe el comando y el bot te guia paso a paso.\n\n"

    "🌅 BRIEFINGS\n"
    "/briefing     → Genera tu resumen matutino ahora mismo\n"
    "/tarde        → Cierre del dia: noticias + tareas completadas\n"
    "/estado       → Ve cuando llega el proximo briefing automatico\n\n"

    "✅ TAREAS\n"
    "/tarea        → Agrega algo a tu lista de pendientes\n"
    "/tareas       → Ve todo lo que tienes pendiente hoy\n"
    "/hecho        → Marca una tarea como completada\n"
    "/borrar       → Elimina una tarea de la lista\n\n"

    "🏙 CHIHUAHUA\n"
    "/gasolina     → Precio actual Magna, Premium y Diesel en la ciudad\n"
    "/restaurante  → A donde ir a comer hoy segun tu antojo\n"
    "/evento       → Que esta pasando en Chihuahua este fin de semana\n"
    "/noticias_chi → Noticias locales de Chihuahua (Norte, Heraldo)\n"
    "/finde        → Ideas de planes para el sabado o domingo\n"
    "/cita         → Plan completo de salida romantica con lugares reales\n\n"

    "🎭 ENTRETENIMIENTO\n"
    "/serie        → Que ver esta noche en Netflix, HBO o Prime\n"
    "/receta       → Dime que tienes en casa, te doy la receta\n"
    "/chiste       → Chiste del dia para arrancar sonriendo\n"
    "/motivacion   → Mensaje motivacional cuando lo necesitas\n"
    ...
    "⚙ CONFIGURACION\n"
    "/hora         → Cambia la hora del briefing matutino\n"
    "/config_cal   → Conecta tu Google Calendar al briefing\n"
